...
public class UpdateAdminform extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UpdateAdminform
     */
    public UpdateAdminform() {
        initComponents();
    }

    public UpdateAdminform(UserModel userModel) {
        initComponents();
...
//        this.user.setText(userModel.getUSERNAME());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UPDATE ADMIN FORM");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(60, 0, 287, 75);
...
.getName() + " = " + ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAdminform.class  
